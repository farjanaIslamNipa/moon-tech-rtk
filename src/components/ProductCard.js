...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
      ...
      <p className='text-center font-semibold mb-1'>Rating: {product.rating}</p>
      {product.quantity && <p className='text-center font-semibold mb-3'>Quantity: {product.quantity}</p>}
